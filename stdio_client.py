...
# (helpful in notebooks or some runtime environments)
nest_asyncio.apply()
...
class MCPClient:
    ...
    async def connect_to_server(self, server_script_path: str):
        ...
        if self.session:
            ...
            # Handle the case where session is None, e.g., raise an error or return
        ...
        if self.session:
            ...
            raise ConnectionError("MCP session not established, cannot list tools.")
